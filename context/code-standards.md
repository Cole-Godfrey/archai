...
- Reference tokens through their Tailwind utility names: `bg-base`, `bg-canvas`, `text-copy-primary`, `border-surface-border`, `text-brand`, `text-ai-text`, etc.
- Maintain the Archai border radius scale: `rounded-md` for inputs and buttons, `rounded-lg` for cards and panels, `rounded-xl` for modals.
